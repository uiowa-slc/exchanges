...
@media only screen{
 .columns{ position: relative; padding-left: 1.09375rem; padding-right: 1.09375rem; float: left; }
...
.news-list article time{ font-size: 0.875rem; line-height: 1em; display: block; text-transform: uppercase; color: rgb(102, 102, 102); font-family: futura-pt, Helvetica, Arial, sans-serif; margin-top: 0.4em; margin-right: 0px; margin-bottom: 0.4em; margin-left: 0px; }