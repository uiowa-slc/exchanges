...
.top-bar-section ul li.active > a{ background-image: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgba(0, 0, 0, 0.398438); color: rgb(154, 209, 232); background-position: initial initial; background-repeat: initial initial; }
...
.cover-container{ background-size: cover; background-color: rgb(102, 102, 102); background-repeat: no-repeat no-repeat; }
