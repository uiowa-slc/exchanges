...
function lint() {
    return gulp
        .src("./themes/exchanges/scripts/**/*.js")
        .pipe($.eslint())
        .pipe($.eslint.format())
...
function images() {
    return gulp
        .src("./themes/exchanges/src/images/**/*")
        .pipe(
            $.imagemin({
                progressive: true,
                interlaced: true,
...
function clean() {
    return del([".tmp", "./themes/exchanges/dist/*", "!dist/.git"], {
        dot: true,
    });
}
...
function watch() {
    ...
    gulp.watch(
        ["./themes/exchanges/src/styles/**/*.{scss,css}"],
        gulp.series(styles)
    );
    gulp.watch(
        ["./themes/exchanges/src/scripts/**/*.js"],
...
gulp.task("default", gulp.series(clean, styles, copy, scripts, watch));
